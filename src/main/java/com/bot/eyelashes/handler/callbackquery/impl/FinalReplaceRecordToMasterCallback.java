...
public class FinalReplaceRecordToMasterCallback implements Callback {
    ...
    public SendMessage getCallbackQuery(CallbackQuery callbackQuery) {
        ...
        String time = callbackQuery.getData().split("/")[1];
        long clientIdFromCallback = Long.parseLong(callbackQuery.getData().split("/")[2]);
        ...
        recordToMasterData.setMasterId(callbackQuery.getMessage().getChatId());
